...
class BalanceUpdatedListenerIT : RabbitIntegrationTest() {
    ...
    @Test
    fun `should consume BalanceUpdatedEvent and mark transaction as completed`() {
        ...
        val event = BalanceUpdatedEvent(
            ...
            accountId = accountId,
            previousBalance = BigDecimal("44.00"),
            delta = BigDecimal("44.00"),
            newBalance = BigDecimal("88.00"),
        ...
        rabbitTemplate.convertAndSend(
            ...
            RabbitConfig.BALANCE_UPDATED_ROUTING_KEY,
            event
        )
